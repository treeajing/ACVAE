...
def main(comb_label, hz_para_list):
    ...
    # Initialize a list of 200 zeros to store autoencoder losses for each epoch
    ae_loss_list = [0]*200
    # Initialize a list of 200 zeros to store KL divergence losses for each epoch
    kl_loss_list = [0]*200
    # Initialize a list of 200 zeros to store total losses for each epoch
    ...
    for i_bootstrap in range(n_bootstrap):
        ...
        for epoch in range(n_epochs): 
            ...
            epoch_dc_loss_avg = MeanMetric()
            epoch_gen_loss_avg = MeanMetric()
            ...
            for batch_idx, batch in enumerate(generator_train): 
                ...
                # Calculate the loss
                loss2 = model.loss_function2(data_curr, fwd_rtn2)
...
if __name__ == "__main__":
    ...
    # Enter the combination label and parameter lists from the command line to try different combinations
    main(args.comb_label, args.hz_para_list)
